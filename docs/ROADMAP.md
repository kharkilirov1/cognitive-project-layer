...
- [x] Better error messages for embedding provider failures.
- [x] Config file for profiles and ignored paths.
- [x] Local dashboard UI for health, retrieval, refresh, eval history, and graph exploration.
- [x] Public CodeSearchNet retrieval benchmark runner.
- [x] Safe local self-heal for stale indexes and embedding DB maintenance.
...
- [x] Query-specific graph traversal policies.
...
- [x] Richer local web UI for trace and graph exploration.
